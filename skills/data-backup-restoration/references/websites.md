...
4. [What happens during the deletion period](#what-happens-during-the-deletion-period)
5. [Maintenance page and SEO treatment](#maintenance-page-and-seo-treatment)
6. [What happens to domains](#what-happens-to-domains)
7. [How to back up a website](#how-to-back-up-a-website)
8. [What restoration brings back](#what-restoration-brings-back)
9. [Migration and temporary DNS changes](#migration-and-temporary-dns-changes)
...
- Users can export multiple times during the backup period. Each export is a point-in-time snapshot and does not sync later changes.
- If a website changes after export, create another backup before the deadline.
