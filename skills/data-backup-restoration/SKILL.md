...
- A backup is a point-in-time snapshot. If the user changes a task after export, create another backup before the deadline.
...
- Confirm that every backup package exists in the chosen destination. Do not modify or rename the packages.
